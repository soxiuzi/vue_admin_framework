<template>
  <div class="register">
    <a-layout class="register_layout">
      <a-layout-content class="register_content">
        ...
        <a-form>
          ...
          <a-button :size="btnSize" type="primary" class="register_btn" @click="register">注册</a-button>
        </a-form>
      </a-layout-content>
    </a-layout>
  </div>
...
import { register } from "_api/login";
export default {
